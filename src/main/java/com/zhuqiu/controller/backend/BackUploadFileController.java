...
import com.zhuqiu.dto.JsonResult;
import com.zhuqiu.dto.UploadFileVO;
...
@Slf4j
@RestController("backUploadFileController")
...
public class BackUploadFileController {
     ...
     * 文件保存目录，物理路径
     */
    public final String rootPath = "D:/KsForum_upload/";
    ...
    public String uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        if (allowSuffix.indexOf(suffix) == -1) {
            return JSON.toJSONString(new JsonResult().fail("不允许上传该后缀的文件！"));
        }
        ...
        JsonResult result = new JsonResult().ok(uploadFileVO);

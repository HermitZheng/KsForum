...
<rapid:override name="content">
    ...
    <br><br>
    <form class="layui-form" action="/back/user/insertSubmit" id="userForm"
          method="post">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">个人简介 <span style="color: #FF5722; "></span></label>
            <div class="layui-input-inline">
                <input type="text" name="userProfile" value="${user.userProfile}"
